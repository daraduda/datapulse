...
- Launch the project locally: "npm run dev"
- Open your browser at `http://localhost:5173` to view the app.

2. **Lint the code**  

- Check code quality with ESLint: "npx eslint ."
- To automatically fix linting issues: "npx eslint --fix"
...
**Run the container**
- docker run -p 5173:5173 -v C:/{root_folder}/{project_folder}/src:/app/src datapulse
